...
var connectWallets = require('@talismn/connect-wallets');
var availJsSdk = require('avail-js-sdk');
...
async function updateMetadata({ api, account, metadataCookie, selectedWallet, setCookie, }) {
    const injector = connectWallets.getWalletBySource(account.source);
...
const initApi = async (rpcUrl, retries = 3) => {
    try {
        ...
        const initializedApi = await availJsSdk.initialize(rpcUrl);
        return initializedApi;
    }
    catch (error) {
        availJsSdk.disconnect();
        if (retries > 0) {
...
const Button = React__namespace.forwardRef(({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return (React__namespace.createElement(Comp, { className: cn(buttonVariants({ variant, size, className })), ref: ref, ...props }));
});
...
function Badge({ className, variant, ...props }) {
    return (React__namespace.createElement("div", { className: cn(badgeVariants({ variant }), className), ...props }));
}
...
const DialogOverlay = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement(Overlay, { ref: ref, className: cn("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className), ...props })));
DialogOverlay.displayName = Overlay.displayName;
const DialogContent = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement(DialogPortal, null,
    React__namespace.createElement(DialogOverlay, null),
    React__namespace.createElement(Content, { ref: ref, className: cn("fixed outline-none focus:outline-none focus:ring-0 ring-0 left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-200 bg- p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-2xl dark:border-gray-800 dark:bg-gray-950", className), ...props },
        children,
        React__namespace.createElement(Close, { className: "absolute right-4 top-4 !rounded-2xl opacity-70 ring-offset-white transition-opacity hover:opacity-100 ofocus:utline-none disabled:pointer-events-none data-[state=open]:bg-gray-100 data-[state=open]:text-gray-500 dark:ring-offset-gray-950  dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-gray-400" },
            React__namespace.createElement(X, { className: "h-6 w-6 text-white" }),
            React__namespace.createElement("span", { className: "sr-only" }, "Close"))))));
DialogContent.displayName = Content.displayName;
const DialogHeader = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("flex flex-col space-y-1.5 text-center sm:text-left", className), ...props }));
DialogHeader.displayName = "DialogHeader";
const DialogFooter = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className), ...props }));
DialogFooter.displayName = "DialogFooter";
const DialogTitle = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement(Title, { ref: ref, className: cn("text-4xl font-semibold leading-none tracking-tight", className), ...props })));
DialogTitle.displayName = Title.displayName;
const DialogDescription = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement(Description, { ref: ref, className: cn("text-sm text-gray-500 dark:text-gray-400", className), ...props })));
...
async function getSnapsProvider() {
    ...
    if ((_a = window.ethereum) === null || _a === void 0 ? void 0 : _a.detected) {
    ...
    if ((_b = window.ethereum) === null || _b === void 0 ? void 0 : _b.providers) {
...
(_a$1 = process.env.SNAP_ORIGIN) !== null && _a$1 !== void 0 ? _a$1 : `npm:@avail-project/avail-snap`;
...
const MetaMaskProvider = ({ children }) => {
    ...
    const [installedSnap, setInstalledSnap] = React.useState(null);
    ...
    return (React.createElement(MetaMaskContext.Provider, { value: { provider, error, setError, installedSnap, setInstalledSnap } }, children));
};
/**
...
var _a;
// Default snap origin
const defaultSnapOrigin = (_a = process.env.SNAP_ORIGIN) !== null && _a !== void 0 ? _a : `npm:@avail-project/avail-snap`;
...
function useRequest() {
    ...
    return async ({ method, params }) => {
        var _a, _b;
        try {
            const data = (_b = await ((_a = context.provider) === null || _a === void 0 ? void 0 : _a.request({
                method,
                params,
...
function useMetaMask() {
    ...
    const getSnap = async () => {
        ...
        setInstalledSnap((_a = snaps[defaultSnapOrigin]) !== null && _a !== void 0 ? _a : null);
    };
    React.useEffect(() => {
        const detect = async () => {
            if (provider) {
...
function useInvokeSnap(snapId = defaultSnapOrigin) {
    const request = useRequest();
...
function useRequestSnap(snapId = defaultSnapOrigin, version) {
    const request = useRequest();
    ...
    const requestSnap = async () => {
        ...
        setInstalledSnap((_a = snaps === null || snaps === void 0 ? void 0 : snaps[snapId]) !== null && _a !== void 0 ? _a : null);
    };
    return requestSnap;
}
...
// THIS FILE IS AUTO GENERATED
function FaArrowRotateRight (props) {
  return GenIcon({"tag":"svg","attr":{"viewBox":"0 0 512 512"},"child":[{"tag":"path","attr":{"d":"M386.3 160H336c-17.7 0-32 14.3-32 32s14.3 32 32 32H464c17.7 0 32-14.3 32-32V64c0-17.7-14.3-32-32-32s-32 14.3-32 32v51.2L414.4 97.6c-87.5-87.5-229.3-87.5-316.8 0s-87.5 229.3 0 316.8s229.3 87.5 316.8 0c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0c-62.5 62.5-163.8 62.5-226.3 0s-62.5-163.8 0-226.3s163.8-62.5 226.3 0L386.3 160z"},"child":[]}]})(props);
}

const DisconnectWallet = React.memo(({ selected, installedSnap, onDisconnect }) => {
    var _a, _b;
    if (!selected)
        return null;
    return (React.createElement("div", { className: badgeVariants({ variant: "avail" }), onClick: () => {
            navigator.clipboard.writeText(selected.address);
        } },
        React.createElement(Wallet, { className: "pr-1 h-5 w-5" }),
        selected.source === "MetamaskSnap"
            ? installedSnap
                ? selected.address.slice(0, 6) + "..." + ((_a = selected.address) === null || _a === void 0 ? void 0 : _a.slice(-4))
                : "Retry Connecting"
            : selected.address.slice(0, 6) + "..." + ((_b = selected.address) === null || _b === void 0 ? void 0 : _b.slice(-4)),
        React.createElement("button", { className: "ml-2", onClick: onDisconnect }, selected.source === "MetamaskSnap" ? (installedSnap ? (React.createElement(IoMdClose, null)) : (React.createElement(FaArrowRotateRight, null))) : (React.createElement(IoMdClose, null)))));
});
DisconnectWallet.displayName = "DisconnectWallet";

const AccountSelector = React.memo(({ selectedWallet, enabledAccounts, onAccountSelect, }) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("br", null),
        selectedWallet && (React.createElement(Button, { variant: "default", className: "!text-lg mt-3 w-full font-thin bg-[#3a3b3cb1] text-left font-ppmori rounded-xl !p-8 " },
            React.createElement("div", { className: "flex flex-row" },
                React.createElement("img", { alt: selectedWallet.title, height: 20, width: 20, src: selectedWallet.logo.src, className: "mr-4" }),
                selectedWallet.title))),
        React.createElement("p", { className: "text-white my-3 !mt-4 text-opacity-70 font-ppmori font-light text-sm flex flex-row items-center justify-center space-x-2" },
            React.createElement("span", null, "Select Accounts"),
            React.createElement(ArrowDownCircle, { className: "h-4 w-4" })),
        React.createElement("div", { className: "flex flex-col gap-2 !max-h-48 overflow-y-scroll overflow-x-hidden pt-2" }, enabledAccounts.map((account, index) => {
            var _a, _b;
            return (React.createElement(Button, { key: index, onClick: () => onAccountSelect(account), className: "flex flex-row items-center justify-between bg-[#3a3b3cb1] rounded-xl !h-14 p-4" },
                React.createElement("div", { className: "flex flex-row items-center justify-start mx-auto w-full" },
                    React.createElement("div", { className: "text-white text-opacity-90 space-x-2 !font-thicccboiregular text-md flex flex-row items-center justify-start" },
                        React.createElement("p", null, "> "),
                        React.createElement("p", { className: "font-thicccboisemibold text-xl cursor-pointer" }, ((_a = account.name) === null || _a === void 0 ? void 0 : _a.length) > 12
                            ? ((_b = account.name) === null || _b === void 0 ? void 0 : _b.slice(0, 12)) + "..."
                            : account.name),
                        React.createElement("p", { className: "text-[#3489E8]" },
                            " ",
                            "(",
...
const WalletSelector = React.memo(({ supportedWallets, onWalletSelect, metamaskInstalled, }) => {
    const sortedWallets = React.useMemo(() => supportedWallets.sort((a, b) => {
        if (a.title === "SubWallet")
            return -1;
        if (b.title === "SubWallet")
            return 1;
        return 0;
    }), [supportedWallets]);
    return (React.createElement("div", { className: "flex flex-col gap-3 max-h-72 overflow-y-scroll" },
        React.createElement(Button, { disabled: !metamaskInstalled, className: "!text-lg font-thin bg-[#3a3b3cb1] text-left font-ppmori rounded-xl !p-8", onClick: () => onWalletSelect({ title: "MetamaskSnap" }), key: "Metamask" },
            React.createElement("div", { className: "flex flex-row" },
                React.createElement("img", { alt: "Metamask Snap", src: availSnap, width: "24", height: "24", className: "mr-4 h-6 w-6" }),
                "Avail Snap")),
        sortedWallets.map((wallet) => (React.createElement(Button, { key: wallet.title, disabled: !wallet.installed, className: "!text-lg font-thin bg-[#3a3b3cb1] text-left font-ppmori rounded-xl !p-8", onClick: () => onWalletSelect(wallet) },
            React.createElement("div", { className: "flex flex-row" },
                React.createElement("img", { alt: wallet.title, height: "20", width: "20", src: wallet.logo.src, className: "mr-4" }),
                wallet.title))))));
});
WalletSelector.displayName = "WalletSelector";

const useAvailAccount = zustand.create()(middleware.persist((set) => ({
    selected: null,
...
const useApi = zustand.create((set, get) => ({
    api: undefined,
    isReady: false,
    setApi: (api) => set({ api }),
    ensureConnection: async (initApiFn) => {
        const currentApi = get().api;
        if ((currentApi === null || currentApi === void 0 ? void 0 : currentApi.isConnected) && (await currentApi.isReady)) {
            set({ isReady: true });
            return;
        }
        try {
...
const AvailWalletConnect = ({ api, }) => {
    const [open, setOpen] = React.useState(false);
    const [supportedWallets, setSupportedWallets] = React.useState([]);
    const [enabledAccounts, setEnabledAccounts] = React.useState([]);
    const { api: storeApi } = useApi();
    const requestSnap = useRequestSnap();
    const invokeSnap = useInvokeSnap();
    const { selected, setSelected, selectedWallet, setSelectedWallet, metadataUpdated, setMetadataUpdated, clearWalletState, } = useAvailAccount();
    const { installedSnap, metamaskInstalled } = useMetaMask();
    const getSupportedWallets = React.useCallback(() => {
        const wallets = connectWallets.getWallets();
    ...
    React.useEffect(() => {
        (async () => {
            ...
            if ((selected === null || selected === void 0 ? void 0 : selected.address) && (selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.title)) {
                if (selectedWallet.title === "MetamaskSnap" && installedSnap) ;
                else {
                    const matchedWallet = wallets.find((wallet) => {
                        return wallet.title === (selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.title);
                    });
                    if (!matchedWallet) {
                        return;
                    }
                    matchedWallet.enable("bridge-ui").then(() => {
                        matchedWallet.getAccounts().then((accounts) => {
                            const enabledAccounts = accounts.filter((account) => {
                                return account.type !== "ethereum";
                            });
                            const selectedAccount = enabledAccounts.find((account) => account.address === (selected === null || selected === void 0 ? void 0 : selected.address));
                            if (!selectedAccount) {
                                return;
                            }
    ...
    const handleWalletSelect = React.useCallback(async (wallet) => {
        if (wallet.title === "MetamaskSnap") {
            try {
                await requestSnap();
                const address = await invokeSnap({ method: "getAddress" });
                setSelected({ address: address, source: "MetamaskSnap" });
                setSelectedWallet({ title: "MetamaskSnap" });
            }
            catch (error) {
    ...
    const handleAccountSelect = React.useCallback(async (account) => {
        setSelected(account);
        ...
        setOpen(false);
        console.info(`AVAIL_WALLET_CONNECT - ${selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.title} - ${account.address}`);
    }, [
        selectedWallet,
        api,
        storeApi,
    ...
    return (React.createElement(React.Fragment, null, selected ? (React.createElement(DisconnectWallet, { selected: selected, installedSnap: installedSnap, onDisconnect: handleDisconnect })) : (React.createElement(Dialog, { open: open, onOpenChange: setOpen },
        React.createElement(DialogTrigger, { asChild: true },
            React.createElement(Button, { variant: "primary", size: "sm", className: "!ml-2" }, "Connect Wallet")),
        React.createElement(DialogContent, { style: {
            ...
            React.createElement(DialogHeader, null,
                ...
                enabledAccounts.length === 0 ? (React.createElement(React.Fragment, null,
                    React.createElement(DialogDescription, { className: "font-thicccboiregular text-md text-white text-opacity-70 pt-2" },
                        React.createElement("div", { className: "flex flex-row font-ppmori items-start justify-start pt-3 space-x-2" },
                            React.createElement(Info, null),
                            React.createElement("span", null,
                                "Don't have an Avail Wallet yet? Checkout this",
                                " ",
                                React.createElement("a", { href: "https://docs.availspace.app/avail-space/web-dashboard-user-guide/getting-started/how-to-install-subwallet-and-create-a-new-avail-account?utm_source=avail&utm_medium=docspace&utm_campaign=avlclaim", className: "underline", target: "_blank" }, "cool tutorial"),
                                " ",
                                "by Subwallet."))),
                    React.createElement("div", { style: {
                            marginBottom: "1rem",
                        } }),
                    React.createElement(WalletSelector, { supportedWallets: supportedWallets, onWalletSelect: handleWalletSelect, metamaskInstalled: metamaskInstalled }))) : (React.createElement(AccountSelector, { selectedWallet: selectedWallet, enabledAccounts: enabledAccounts, onAccountSelect: handleAccountSelect }))),
            React.createElement(DialogFooter, { style: {
                    display: "flex",
                    width: "100%",
                    marginTop: "0.5rem",
                ...
                React.createElement("div", { style: { textAlign: "center" } }, enabledAccounts && enabledAccounts.length > 0 ? (React.createElement(Button, { disabled: enabledAccounts.length <= 0, variant: "outline", style: {
                    ...
                    React.createElement(ArrowLeft, { style: {
                            height: "1.75rem",
                            width: "1.75rem",
                            paddingRight: "0.5rem",
                        } }),
                    " ",
                    React.createElement("span", { style: { fontSize: "1.125rem" } }, "Go back to wallets"))) : (React.createElement("p", { style: { textAlign: "center" } },
                    " ",
                    "Scroll to find more wallets",
                    " ")))))))));
};

const AvailWalletContext = React.createContext({
    isConnected: false,
    setRpcUrl: () => { },
});
const useAvailWallet = () => React.useContext(AvailWalletContext);
const AvailWalletProvider = ({ children, api: externalApi, rpcUrl: userProvidedRpcUrl }) => {
    const DEFAULT_RPC_URL = "wss://turing-rpc.avail.so/";
    const [rpcUrl, setRpcUrl] = React.useState(userProvidedRpcUrl || DEFAULT_RPC_URL);
    const { selected, setSelected, selectedWallet, setSelectedWallet, metadataUpdated } = useAvailAccount();
    ...
    React.useEffect(() => {
        const loadPersistedWallet = async () => {
            if (!(selected === null || selected === void 0 ? void 0 : selected.address) || !(selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.title) || !isReady) {
                return;
            }
            if (selectedWallet.title !== "MetamaskSnap") {
                const wallets = connectWallets.getWallets();
                const savedWallet = wallets.find((wallet) => wallet.title === selectedWallet.title);
                if (!savedWallet)
                    return;
                try {
                    ...
                    const savedAccount = substrateAccounts.find((account) => account.address === selected.address);
                    if (savedAccount) {
    ...
    return (React.createElement(MetaMaskProvider, null,
        React.createElement(AvailWalletContext.Provider, { value: {
                api: api,
                isConnected: isReady,
                rpcUrl: rpcUrl,
                setRpcUrl,
...
exports.AvailWalletConnect = AvailWalletConnect;
exports.AvailWalletProvider = AvailWalletProvider;
exports.Badge = Badge;
...
exports.MetaMaskContext = MetaMaskContext;
...
exports.useAvailAccount = useAvailAccount;
exports.useAvailWallet = useAvailWallet;
