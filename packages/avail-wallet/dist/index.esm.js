...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (React.createElement(Overlay, { ref: ref, className: cn("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className), ...props })));
...
const DialogTitle = React.forwardRef(({ className, ...props }, ref) => (React.createElement(Title, { ref: ref, className: cn("text-4xl font-semibold leading-none tracking-tight", className), ...props })));
DialogTitle.displayName = Title.displayName;
const DialogDescription = React.forwardRef(({ className, ...props }, ref) => (React.createElement(Description, { ref: ref, className: cn("text-sm text-gray-500 dark:text-gray-400", className), ...props })));
...
const MetaMaskProvider = ({ children }) => {
    ...
    return (React__default.createElement(MetaMaskContext.Provider, { value: { provider, error, setError, installedSnap, setInstalledSnap } }, children));
};
/**
...
const DisconnectWallet = memo(({ selected, installedSnap, onDisconnect }) => {
    var _a, _b;
    if (!selected)
        return null;
    return (React__default.createElement("div", { className: badgeVariants({ variant: "avail" }), onClick: () => {
            navigator.clipboard.writeText(selected.address);
        } },
        React__default.createElement(Wallet, { className: "pr-1 h-5 w-5" }),
        ...
        React__default.createElement("button", { className: "ml-2", onClick: onDisconnect }, selected.source === "MetamaskSnap" ? (installedSnap ? (React__default.createElement(IoMdClose, null)) : (React__default.createElement(FaArrowRotateRight, null))) : (React__default.createElement(IoMdClose, null)))));
});
DisconnectWallet.displayName = "DisconnectWallet";

const AccountSelector = memo(({ selectedWallet, enabledAccounts, onAccountSelect, }) => {
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("br", null),
        selectedWallet && (React__default.createElement(Button, { variant: "default", className: "!text-lg mt-3 w-full font-thin bg-[#3a3b3cb1] text-left font-ppmori rounded-xl !p-8 " },
            React__default.createElement("div", { className: "flex flex-row" },
                React__default.createElement("img", { alt: selectedWallet.title, height: 20, width: 20, src: selectedWallet.logo.src, className: "mr-4" }),
                selectedWallet.title))),
        React__default.createElement("p", { className: "text-white my-3 !mt-4 text-opacity-70 font-ppmori font-light text-sm flex flex-row items-center justify-center space-x-2" },
            React__default.createElement("span", null, "Select Accounts"),
            React__default.createElement(ArrowDownCircle, { className: "h-4 w-4" })),
        React__default.createElement("div", { className: "flex flex-col gap-2 !max-h-48 overflow-y-scroll overflow-x-hidden pt-2" }, enabledAccounts.map((account, index) => {
            var _a, _b;
            return (React__default.createElement(Button, { key: index, onClick: () => onAccountSelect(account), className: "flex flex-row items-center justify-between bg-[#3a3b3cb1] rounded-xl !h-14 p-4" },
                React__default.createElement("div", { className: "flex flex-row items-center justify-start mx-auto w-full" },
                    React__default.createElement("div", { className: "text-white text-opacity-90 space-x-2 !font-thicccboiregular text-md flex flex-row items-center justify-start" },
                        React__default.createElement("p", null, "> "),
                        React__default.createElement("p", { className: "font-thicccboisemibold text-xl cursor-pointer" }, ((_a = account.name) === null || _a === void 0 ? void 0 : _a.length) > 12
                            ? ((_b = account.name) === null || _b === void 0 ? void 0 : _b.slice(0, 12)) + "..."
                            : account.name),
                        React__default.createElement("p", { className: "text-[#3489E8]" },
                            " ",
                            "(",
...
const WalletSelector = memo(({ supportedWallets, onWalletSelect, metamaskInstalled, }) => {
    const sortedWallets = React__default.useMemo(() => supportedWallets.sort((a, b) => {
    ...
    return (React__default.createElement("div", { className: "flex flex-col gap-3 max-h-72 overflow-y-scroll" },
        React__default.createElement(Button, { disabled: !metamaskInstalled, className: "!text-lg font-thin bg-[#3a3b3cb1] text-left font-ppmori rounded-xl !p-8", onClick: () => onWalletSelect({ title: "MetamaskSnap" }), key: "Metamask" },
            React__default.createElement("div", { className: "flex flex-row" },
                React__default.createElement("img", { alt: "Metamask Snap", src: availSnap, width: "24", height: "24", className: "mr-4 h-6 w-6" }),
                "Avail Snap")),
        sortedWallets.map((wallet) => (React__default.createElement(Button, { key: wallet.title, disabled: !wallet.installed, className: "!text-lg font-thin bg-[#3a3b3cb1] text-left font-ppmori rounded-xl !p-8", onClick: () => onWalletSelect(wallet) },
            React__default.createElement("div", { className: "flex flex-row" },
                React__default.createElement("img", { alt: wallet.title, height: "20", width: "20", src: wallet.logo.src, className: "mr-4" }),
                wallet.title))))));
});
WalletSelector.displayName = "WalletSelector";

const useAvailAccount = create()(persist((set) => ({
    selected: null,
...
const AvailWalletConnect = ({ api, }) => {
    ...
    return (React__default.createElement(React__default.Fragment, null, selected ? (React__default.createElement(DisconnectWallet, { selected: selected, installedSnap: installedSnap, onDisconnect: handleDisconnect })) : (React__default.createElement(Dialog, { open: open, onOpenChange: setOpen },
        React__default.createElement(DialogTrigger, { asChild: true },
            React__default.createElement(Button, { variant: "primary", size: "sm", className: "!ml-2" }, "Connect Wallet")),
        React__default.createElement(DialogContent, { style: {
            ...
            React__default.createElement(DialogHeader, null,
                React__default.createElement(DialogTitle, { style: {
                        color: "white",
                        fontSize: "2rem",
                        marginBottom: "1rem",
                    } }, "Connect Wallet"),
                enabledAccounts.length === 0 ? (React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(DialogDescription, { className: "font-thicccboiregular text-md text-white text-opacity-70 pt-2" },
                        React__default.createElement("div", { className: "flex flex-row font-ppmori items-start justify-start pt-3 space-x-2" },
                            React__default.createElement(Info, null),
                            React__default.createElement("span", null,
                                "Don't have an Avail Wallet yet? Checkout this",
                                " ",
                                React__default.createElement("a", { href: "https://docs.availspace.app/avail-space/web-dashboard-user-guide/getting-started/how-to-install-subwallet-and-create-a-new-avail-account?utm_source=avail&utm_medium=docspace&utm_campaign=avlclaim", className: "underline", target: "_blank" }, "cool tutorial"),
                                " ",
                                "by Subwallet."))),
                    React__default.createElement("div", { style: {
                            marginBottom: "1rem",
                        } }),
                    React__default.createElement(WalletSelector, { supportedWallets: supportedWallets, onWalletSelect: handleWalletSelect, metamaskInstalled: metamaskInstalled }))) : (React__default.createElement(AccountSelector, { selectedWallet: selectedWallet, enabledAccounts: enabledAccounts, onAccountSelect: handleAccountSelect }))),
            React__default.createElement(DialogFooter, { style: {
                    display: "flex",
                    width: "100%",
                    marginTop: "0.5rem",
                ...
                React__default.createElement("div", { style: { textAlign: "center" } }, enabledAccounts && enabledAccounts.length > 0 ? (React__default.createElement(Button, { disabled: enabledAccounts.length <= 0, variant: "outline", style: {
                    ...
                    React__default.createElement(ArrowLeft, { style: {
                            height: "1.75rem",
                            width: "1.75rem",
                            paddingRight: "0.5rem",
                        } }),
                    " ",
                    React__default.createElement("span", { style: { fontSize: "1.125rem" } }, "Go back to wallets"))) : (React__default.createElement("p", { style: { textAlign: "center" } },
                    " ",
                    "Scroll to find more wallets",
                    " ")))))))));
};

const AvailWalletContext = createContext({
    isConnected: false,
    setRpcUrl: () => { },
});
const useAvailWallet = () => useContext(AvailWalletContext);
const AvailWalletProvider = ({ children, api: externalApi, rpcUrl: userProvidedRpcUrl }) => {
    ...
    const [rpcUrl, setRpcUrl] = useState(userProvidedRpcUrl || DEFAULT_RPC_URL);
    ...
    return (React__default.createElement(MetaMaskProvider, null,
        React__default.createElement(AvailWalletContext.Provider, { value: {
                api: api,
                isConnected: isReady,
                rpcUrl: rpcUrl,
                setRpcUrl,
...
export { ASSETS_PATH, AccountSelector, AvailWalletConnect, AvailWalletProvider, Badge, Button, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DisconnectWallet, MetaMaskContext, MetaMaskProvider, WalletSelector, getInjectorMetadata, initApi, updateMetadata, useApi, useAvailAccount, useAvailWallet, useInvokeSnap, useMetaMask, useMetaMaskContext, useRequestSnap };
