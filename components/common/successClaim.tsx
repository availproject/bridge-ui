...
type SuccessDialogProps = {
  ...
  export const SuccessDialog = ({ isOpen, onClose, destinationChain, destinationTxnHash }: SuccessDialogProps) => {
    return (
          ...
          <div className="flex flex-col items-center justify-center !space-x-3 mt-2">
            ...
            <div className="flex flex-col space-y-2">
              <p className="font-ppmori text-white text-sm text-opacity-60 mt-4">
                ...
                successfully submitted to the chain. Your funds will be deposited to
                the destination account, generally within
                <span className="text-white italics"> ~15-30 minutes.</span> <br />
                <span>
