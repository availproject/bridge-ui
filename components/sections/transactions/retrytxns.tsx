...
export const RetryTxns = ({
  ...
  return (
    <LoadingButton
      ...
      className="w-full rounded-xl font-thicccboibold px-7 py-3 !bg-[#395358] border-1 border-green-500 !text-white hover:bg-green-500/10 transition-colors duration-300 relative overflow-hidden"
      onClick={onRetry}
    >
