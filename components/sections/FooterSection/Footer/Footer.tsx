        ...
        },
        {
            ...
            subLinks:[
                ...
                },
                {
                    id:3,
                    label:'API Docs',
                    link:EXTERNAL_URLS.API_DOCS
                },
                {
                    id:4,
                    label:'Validators',
                    link:EXTERNAL_URLS.VALIDATOR
                },
                {
                    id:5,
                    label:'Faucet',
                    link:EXTERNAL_URLS.FAUCET
                },
                {
                    id:6,
                    label:'Explorer',
                    link:EXTERNAL_URLS.EXPLORER
                },
                {
                    id:7,
                    label:'Login',
            ...
            subLinks:[
                {
                    id:1,
                    label:'How it works',
                    link:EXTERNAL_URLS.WORKING
                },
                {
                    id:2,
                    label:'Become a validator',
                    link:EXTERNAL_URLS.BECOME_VALIDATOR
                }
            ]
        },
        {
        ...
        <footer className={footerStyle.footer_container}>
            ...
            <div className={footerStyle.footer}>
                <div>
                    ...
                    <div>
                        <Link href={EXTERNAL_URLS.DISCORD} target='_blank' aria-label='dicord'>
                            <img src={"/images/discord_white.png"} width={'18px'} height={'14px'} alt='dicord' />
                        </Link>
                        <Link href={EXTERNAL_URLS.GITHUB} target='_blank' aria-label='github'>
                            <img src={"/images/github.png"} width={'16px'} height={'18px'} alt='github' />
                        </Link>
                        <Link href={EXTERNAL_URLS.TWITTER} target='_blank' aria-label='twitter'>
                            <img src={"/images/twitter.png"} width={'18px'} height={'15px'} alt='twitter' />
                        </Link>
                        <Link href={EXTERNAL_URLS.LINKEDIN} target='_blank' aria-label='linkedin'>
