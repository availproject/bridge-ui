...
export const appConfig: AppConfig = {
    ...
    liquidityBridgeApiBaseUrl: process.env.NEXT_PUBLIC_LIQUIDITY_BRIDGE_API_URL || 'https://turing-liquidity-bridge.fra.avail.so',
    ...
    contracts: {
      ...
      avail: {
        liquidityBridgeAddress: process.env.NEXT_PUBLIC_LP_ADDRESS_AVAIL || '5Hn8x2fstQmcqLg4C8pEiLWdAJhGaRv8jfYRUrnHeiMALvAX',
      }
    }
};